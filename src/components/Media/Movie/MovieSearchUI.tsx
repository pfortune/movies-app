...
import FilterCard from "./SearchMoviesCard";
...
const MovieSearchUI: React.FC<MovieSearchUIProps> = ({ onFilterValuesChange, genreFilter, startYearFilter, endYearFilter }) => {
